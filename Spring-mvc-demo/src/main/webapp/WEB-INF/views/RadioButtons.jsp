...
SpringIOC: <form:radiobutton path="favLanguage" value="springIOC"/>
SpringMVC: <form:radiobutton path="favLanguage" value="springMVC"/>
<br><br>
OperatingSystem:

OS: <form:checkbox path="OperatingSystem" value="OS"/>
